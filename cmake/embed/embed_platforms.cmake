...
function(libelf_platform_config patch_cmd configure_cmd build_cmd install_cmd)
  ...
  set(libelf_build_cmd BUILD_COMMAND /bin/bash -c "cd <BINARY_DIR>/lib && make -j${nproc} && \
...
#define dgettext(x,y)   (y) \n\
 \n\
    ...
    set(libelf_config_cmd CONFIGURE_COMMAND /bin/bash -xc "${ELFUTILS_CROSS_EXPORTS} && \
                                  cd <BINARY_DIR> && \
...
function(bcc_platform_config patch_cmd configure_flags build_cmd install_cmd)
  ...
  if(${TARGET_TRIPLE} MATCHES android)
    ...
    # FIXME need to determine this dynamically for 64 bit arch
    # FIXME non matching if?
    set(BITS_H_HACK "\n\
#pragma once \n \
#ifndef __WORDSIZE \n \
